export const tableRocketFirstColumn = async(Rocket) =>{
    ...
    span2.textContent = "Number of stage"
...
export const tableRocketSecondColumn = async (Rocket) => {
    let information__table__2 = document.querySelector("#information__table__2");
    information__table__2.innerHTML = "";
    let h3 = document.createElement("h3");
    h3.textContent = "Engine Informartion"
    let hr = document.createElement("hr");
    ...
    let strong4 = document.createElement("strong");
    strong4.textContent = `${(Rocket.engines.stage_1_fuel) ? Rocket.engines.propellant_1 : ""}`
    div4.append(span4, strong4)
